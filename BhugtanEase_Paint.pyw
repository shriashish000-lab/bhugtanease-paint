...
# ─── DATABASE PATH ────────────────────────────────────────────────────────────
DB_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bhugtanease_paint.db")
...
def _show_activate_window():
    ...
    W = 560
    root.geometry(f"{W}x100")   # temp height; asli height neeche content ke hisaab se set hogi
    ...
    # Content ke hisaab se window size auto-fit karo (taaki neeche se kuch cut na ho)
